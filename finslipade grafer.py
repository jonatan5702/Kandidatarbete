...
# Läs in data
SMHI_lufttemperatur_df = pd.read_csv("C:/Users/marcu/OneDrive/Dokument/CHALMERS/KANDIDATEN/PYTHON/rå data/SMHI/SMHI_lufttemperatur.csv", sep=";")
SMHI_nederbord_df = pd.read_csv("C:/Users/marcu/OneDrive/Dokument/CHALMERS/KANDIDATEN/PYTHON/rå data/SMHI/SMHI_nederbord.csv", sep=";")
SMHI_solinstralning_df = pd.read_csv("C:/Users/marcu/OneDrive/Dokument/CHALMERS/KANDIDATEN/PYTHON/rå data/SMHI/SMHI_solinstralning.csv", sep=";")
...
SMHI_vindhast_och_riktning_df = pd.read_csv("C:/Users/marcu/OneDrive/Dokument/CHALMERS/KANDIDATEN/PYTHON/rå data/SMHI/SMHI_vindhast_och_riktning.csv", sep=";")
...
for df in dfs:
    ...
    for col in df.columns:
        ...
        col = re.sub(r"/", "-", col)
        filename = f"C:/Users/marcu/OneDrive/Dokument/CHALMERS/KANDIDATEN/PYTHON/png's/output/{col}.png"
